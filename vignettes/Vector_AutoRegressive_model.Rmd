...
data1 <- fitted_VAR(data0, b_0 = fitted_param$b_0, B = fitted_param$B)

# Plot original data with fitted values
par(mfrow = c(1, 2))
plot_mts(data0, xlab = "time", ylab = "index", main = "Data")
plot_mts(data1, xlab = "time", ylab = "index", main = "Fitted values")
par(mfrow = c(1, 1))

# Forecast
data2 <- predict_VAR(50, data0, b_0 = fitted_param$b_0, B = fitted_param$B)
plot_mts(data2, xlab = "time", ylab = "index", main = "Forecast")

# Forecast with bands
posterior_density <- VAR_posterior_forecast(50, data0, res)
